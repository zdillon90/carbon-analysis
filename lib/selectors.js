const carbonSelectors = {
  userFeild: '#email-input',
  passFeild: '#password-input',
  ...
  partsList: '.item-list',
  firstPart: 'div.item-list > div.part-list-item:nth-child(1)',
  secondPart: 'div.item-list > div.part-list-item:nth-child(2)',
  orientTab:
...
const inshapeSelectors = {
  loginButton: '.gpluslogin-button',
};
