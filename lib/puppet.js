...
async function deleteOldModel(page, oldModel) {
  ...
  await page
    .waitForSelector(carbonSelectors.oldPart)
    .then(() => console.log('Old Part on seen'));
  await page.click(carbonSelectors.oldPart);
  console.log('Old Part slected');
  await page.keyboard.press('Delete');
  console.log('Old Part Deleted!');
}

async function layoutPart() {
...
export { startup, login, newTab, gotoURL, uploadModel, deleteOldModel, close };
